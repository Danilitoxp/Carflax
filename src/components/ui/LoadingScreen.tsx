export function LoadingScreen() {
  // Resolve o tema de forma síncrona (a classe `.dark` só é aplicada no root
  // depois da montagem, então o `dark:` do Tailwind não vale no primeiro paint).
  let isDark = true; // padrão da aplicação é dark
  try {
    const stored = localStorage.getItem("carflax-theme");
