...
export const CircularTestimonialsDemo = () => (
  <section className="w-full space-y-8 p-4">
    ...
    <div className="bg-[#f7f7fa] p-8 md:p-20 rounded-2xl min-h-[300px] flex flex-wrap gap-6 items-center justify-center relative shadow-lg">
      <div
    ...
    <div className="bg-[#060507] p-8 md:p-16 rounded-2xl min-h-[300px] flex flex-wrap gap-6 items-center justify-center relative shadow-lg">
      <div
        className="items-center justify-center relative flex w-full"
